    ...
    <SafeAreaView className="flex-1 bg-white">
        ...
        <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 140 }}>
            ...
            <View>
                ...
                <Text className="font-geist font-bold text-base text-black">
            ...
            <View className="flex-row flex-wrap gap-2">
                <View className="flex-row items-center gap-1 px-3 h-7 rounded bg-surface border border-border">
                ...
                <Text className="text-xs text-black font-bold flex items-center">
                    Urgent
                </Text>
                </View>
            </View>
            ...
            {/* Title */}
            <Text className="text-2xl font-geist font-bold text-black">
            ...
            <View className="pt-4 border-t border-border">
                ...
                <Text className="text-base leading-relaxed text-black font-inter">
                {requestDetails?.description}
                </Text>
            </View>

            {/* Meta */}
            <View className="flex-row gap-4 bg-white p-4 rounded border border-border">
        ...
        {/* Bottom Action Bar */}
        <View className="absolute bottom-0 left-0 right-0 bg-white/90 border-t border-border px-4 py-4">
            <View className="flex-row gap-3">
            { role === "seller" && (
                <TouchableOpacity onPress={() => chatSheetRef.current?.expand()} className="flex-[2] h-14 rounded bg-primary items-center justify-center flex-row gap-2">
