...
const _layout = () => {
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="absolute bottom-0 w-full border-t border-[#f4f1f0] bg-white px-4 pb-3 pt-2 flex-row justify-around">
        <TouchableOpacity className="items-center">
          <Home size={24} color="#171311" fill="#171311" />
        </TouchableOpacity>
        <TouchableOpacity className="items-center">
          <Search size={24} color="#876d64" />
        </TouchableOpacity>
        <TouchableOpacity className="items-center">
          <PlusSquare size={24} color="#876d64" />
        </TouchableOpacity>
        <TouchableOpacity className="items-center">
          <Heart size={24} color="#876d64" />
        </TouchableOpacity>
        <TouchableOpacity className="items-center">
          <User size={24} color="#876d64" />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
