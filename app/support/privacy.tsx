    ...
    <SafeAreaView className="flex-1 bg-surface-page" edges={["top", "bottom"]}>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="px-6 py-8">
          ...
          <Text className={`text-xs uppercase tracking-widest mb-8 text-text-secondary`}>
            Last Updated: May 04, 2026
          </Text>

          <Text className={`text-sm leading-6 mb-6 text-text-primary`}>
          ...
          <View className="mb-8">
            <Text className={`font-bold text-lg mb-4 text-text-primary`}>
              1. WHAT INFORMATION DO WE COLLECT?
            </Text>
            <Text className={`font-bold text-[15px] mb-2 text-text-primary`}>
              Personal information you disclose to us
            </Text>
            <Text className={`text-sm leading-6 mb-4 text-text-secondary`}>
