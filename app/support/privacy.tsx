    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: isDark ? "#1a1c1d" : "white" }} edges={["top", "bottom"]}>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="px-6 py-8">
          ...
          <Text className={`text-xs uppercase tracking-widest mb-8 ${isDark ? "text-[#c6c5cf]" : "text-tertiary"}`}>
            Last Updated: May 04, 2026
          </Text>

          <Text className={`text-sm leading-6 mb-6 ${isDark ? "text-[#f0f1f2]" : "text-black"}`}>
          ...
          <View className="mb-8">
            <Text className={`font-bold text-lg mb-4 ${isDark ? "text-[#f0f1f2]" : "text-black"}`}>
              1. WHAT INFORMATION DO WE COLLECT?
            </Text>
            <Text className={`font-bold text-[15px] mb-2 ${isDark ? "text-[#f0f1f2]" : "text-black"}`}>
              Personal information you disclose to us
            </Text>
            <Text className={`text-sm leading-6 mb-4 ${isDark ? "text-[#c6c5cf]" : "text-tertiary"}`}>
